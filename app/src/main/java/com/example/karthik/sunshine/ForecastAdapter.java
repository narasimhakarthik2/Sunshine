...
import com.example.karthik.sunshine.utilities.SunshineDateUtils;
import com.example.karthik.sunshine.utilities.SunshineWeatherUtils;
...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
         ...
         * Weather Icon *
         ****************/
        int weatherId = mCursor.getInt(ForecastActivity.INDEX_WEATHER_CONDITION_ID);
        int weatherImageId;
        ...
        long dateInMillis = mCursor.getLong(ForecastActivity.INDEX_WEATHER_DATE);
        ...
        double highInCelsius = mCursor.getDouble(ForecastActivity.INDEX_WEATHER_MAX_TEMP);
        /*
        ...
        double lowInCelsius = mCursor.getDouble(ForecastActivity.INDEX_WEATHER_MIN_TEMP);
        /*
         * If the user's preference for weather is fahrenheit, formatTemperature will convert
         * the temperature. This method will also append either °C or °F to the temperature
         * String.
